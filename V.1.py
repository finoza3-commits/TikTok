...
def get_tiktok_best_sellers():
    ...
    payload = {
        "model": "gpt-4o-mini",
        "messages": [
            {"role": "system", "content": "คุณคือผู้เชี่ยวชาญด้าน E-commerce และ TikTok Shop ทำหน้าที่วิเคราะห์เทรนด์สินค้าที่กำลังเป็นกระแส (สินค้าที่ระบบกำลังดัน) และสินค้าขายดีรายวัน ตอบเป็นภาษาไทยให้อ่านง่าย กระชับ เหมาะกับการส่งใน Telegram"},
            {"role": "user", "content": "ช่วยรายงาน 1. สินค้าที่ 'กำลังโดนดัน' หรือเป็นกระแสมาแรงใน TikTok ช่วงนี้ และ 2. สินค้าขายดีประจำวัน รวม 3-5 อันดับ พร้อมบอกเหตุผลสั้นๆ ว่าทำไมถึงฮิต และให้คำแนะนำสำหรับพ่อค้าแม่ค้า (จำลองตัวเลขยอดขายเพื่อให้เห็นภาพด้วย)"}
        ],
        "temperature": 0.7
    }
